...
export class DiscoveryV1beta1Api {
     ...
     * @param body 
     */
    public deleteCollectionNamespacedEndpointSlice(namespace: string, pretty?: string, _continue?: string, dryRun?: string, fieldSelector?: string, gracePeriodSeconds?: number, labelSelector?: string, limit?: number, orphanDependents?: boolean, propagationPolicy?: string, resourceVersion?: string, timeoutSeconds?: number, body?: models.V1DeleteOptions, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     */
    public listEndpointSliceForAllNamespaces(allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public listNamespacedEndpointSlice(namespace: string, pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1EndpointSliceList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices'.replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
     ...
     */
    public readNamespacedEndpointSlice(name: string, namespace: string, pretty?: string, exact?: boolean, _export?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1EndpointSlice;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/discovery.k8s.io/v1beta1/namespaces/{namespace}/endpointslices/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
