...
export class AuthenticationV1beta1Api {
     ...
     */
    public createTokenReview(body: models.V1beta1TokenReview, dryRun?: string, fieldManager?: string, pretty?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1TokenReview;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/authentication.k8s.io/v1beta1/tokenreviews';
        ...
        $.ajax(requestOptions).then(
            (data: models.V1beta1TokenReview, textStatus: string, jqXHR: JQueryXHR) =>
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/authentication.k8s.io/v1beta1/';
