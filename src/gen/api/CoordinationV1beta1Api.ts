...
export class CoordinationV1beta1Api {
     ...
     */
    public createNamespacedLease(namespace: string, body: models.V1beta1Lease, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1Lease;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases'.replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
        ...
        $.ajax(requestOptions).then(
            (data: models.V1beta1Lease, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     * @param body 
     */
    public deleteCollectionNamespacedLease(namespace: string, pretty?: string, _continue?: string, dryRun?: string, fieldSelector?: string, gracePeriodSeconds?: number, labelSelector?: string, limit?: number, orphanDependents?: boolean, propagationPolicy?: string, resourceVersion?: string, timeoutSeconds?: number, body?: models.V1DeleteOptions, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
    ...
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/coordination.k8s.io/v1beta1/';
     ...
     */
    public listLeaseForAllNamespaces(allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1LeaseList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/coordination.k8s.io/v1beta1/leases';
        ...
        >();
        $.ajax(requestOptions).then(
            (data: models.V1beta1LeaseList, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public listNamespacedLease(namespace: string, pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, timeoutSeconds?: number, watch?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1LeaseList;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases'.replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
     ...
     */
    public readNamespacedLease(name: string, namespace: string, pretty?: string, exact?: boolean, _export?: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1Lease;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replaceNamespacedLease(name: string, namespace: string, body: models.V1beta1Lease, pretty?: string, dryRun?: string, fieldManager?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.V1beta1Lease;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}'.replace('{' + 'name' + '}', encodeURIComponent(String(name))).replace('{' + 'namespace' + '}', encodeURIComponent(String(namespace)));
